 ...
 * `isActive()` on both the bearer-token and credential-validation paths and
 * reject authentication if it returns `false`. Use this to honour banned /
 * suspended / soft-deleted identities without relying on short access-token
 * lifetimes alone.
 *
