 ...
 *
 * Adds `@method` PHPDoc tags for the contextual accessors registered
 * as macros by `AuthServiceProvider::boot()` so IDEs can autocomplete
 * `Auth::principal()`, `Auth::device()`, etc. Consumers may use the
 * framework facade directly — this subclass is purely sugar.
 *
